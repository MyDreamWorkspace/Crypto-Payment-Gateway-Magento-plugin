...
define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Eligmaltd_GoCryptoPay/payment/form',
                transactionResult: ''
            },
            ...
            getDesc: function() {
                if(window.checkoutConfig.payment.gocrypto_pay.currentLocaleCode === 'en_US') return "Instant and secure crypto payments.";
                else if(window.checkoutConfig.payment.gocrypto_pay.currentLocaleCode === 'sl_SL') {
                    return "Takojšnja in varna kripto plačila.";
                }
                else { return ""; }
            },
